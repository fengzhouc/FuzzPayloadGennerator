...
public class CommonStore {
    ...
    // 复杂度要求
    public static boolean CHECKCONTAINDIGIT_OFF = false; // 复杂度：数字
    public static boolean CHECKCONTAINLOWERCASE_OFF = false; // 复杂度：小写字母
    public static boolean CHECKCONTAINUPPERCASE_OFF = false; // 复杂度：大写字母
    public static boolean CHECKCONTAINSPECIALCHAR_OFF = false; // 复杂度：特殊字符
    ...
    public static boolean NUMBER_OFF = false; // 基础数据集：数字
    public static boolean SPECIAL_OFF = false; // 基础数据集：特殊字符
    ...
    public static boolean DEFAULT_OFF = false; // 基础数据集：常见用户特征.可添加
